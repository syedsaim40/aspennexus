...
import serviceNav1 from "../public/Images/serviceNav.webp"
import serviceNav2 from "../public/Images/serviceNav2.svg"
import serviceNav3 from "../public/Images/serviceNav3.svg"
import serviceNav4 from "../public/Images/serviceNav4.svg"
import "./common.scss";
         ...
         <div className="service_banner">
          ...
          <div className='service_Holder'>
            <div className='service_Nav'>
              ...
              <div className='nav_Item'><h2>Development</h2></div>
              <div className='nav_Item'><h2>Management</h2></div>
              <div className='nav_Item'><h2>Reporting</h2></div>
            </div>
            <div className='service_Text'>
              <div className='nav_Content'><p>We work closely with you to understand your brand, target audience, and business objectives.</p>
